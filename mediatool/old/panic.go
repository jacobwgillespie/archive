...
mediatool crashed! This is indicative of a bug within mediatool.
A crash log has been placed at "crash.log" relative to your current
working directory. It would be immensely helpful if you could please
report the crash with mediatool[1] so that we can fix this.

When reporting bugs, please include your mediatool version. That
information is available on the first line of crash.log. You can also
get it by running 'mediatool -version' on the command line.

[1]: https://github.com/media-tool/mediatool/issues

!!!!!!!!!!!!!!!!!!!!!!!!!!! MEDIATOOL CRASH !!!!!!!!!!!!!!!!!!!!!!!!!!!
`

// panicHandler is what is called by panicwrap when a panic is encountered
// within mediatool. It is guaranteed to run after the resulting process has

...
// Semaphore is a wrapper around a channel to provide utility methods
// to clarify that we are treating the channel as a semaphore.
type Semaphore chan struct{}

// NewSemaphore creates a semaphore that allows up to
// a given limit of simultaneious acquisitions

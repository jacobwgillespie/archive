...
// MP4Integer8Array needs documentation
type MP4Integer8Array struct {
	mElements       []uint8
...
func (a *MP4Integer8Array) ValidIndex(index MP4ArrayIndex) bool {
	return index < a.mNumElements
}

// Size needs documentation
func (a *MP4Integer8Array) Size() MP4ArrayIndex {
	return a.mNumElements
}

// MaxSize needs documentation
func (a *MP4Integer8Array) MaxSize() MP4ArrayIndex {
	return a.mMaxNumElements
}

// Add needs documentation
func (a *MP4Integer8Array) Add(newElement uint8) {
	a.Insert(newElement, a.mNumElements)
}

// Insert needs documentation
func (a *MP4Integer8Array) Insert(newElement uint8, newIndex MP4ArrayIndex) {
...
func (a *MP4Integer8Array) Delete(index MP4ArrayIndex) {
...
func (a *MP4Integer8Array) Resize(newSize MP4ArrayIndex) {
...
func (a *MP4Integer8Array) Get(index MP4ArrayIndex) uint8 {
	if a.ValidIndex(index) {
...
func (a *MP4Integer8Array) Set(index MP4ArrayIndex, value uint8) {
	if a.ValidIndex(index) {

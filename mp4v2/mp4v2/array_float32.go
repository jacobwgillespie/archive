...
// MP4Float32Array needs documentation
type MP4Float32Array struct {
	mElements       []float32
...
func (a *MP4Float32Array) ValidIndex(index MP4ArrayIndex) bool {
	return index < a.mNumElements
}

// Size needs documentation
func (a *MP4Float32Array) Size() MP4ArrayIndex {
	return a.mNumElements
}

// MaxSize needs documentation
func (a *MP4Float32Array) MaxSize() MP4ArrayIndex {
	return a.mMaxNumElements
}

// Add needs documentation
func (a *MP4Float32Array) Add(newElement float32) {
	a.Insert(newElement, a.mNumElements)
}

// Insert needs documentation
func (a *MP4Float32Array) Insert(newElement float32, newIndex MP4ArrayIndex) {
	...
	if a.mNumElements == a.mMaxNumElements {
		...
		newMElements := make([]float32, a.mMaxNumElements)
...
func (a *MP4Float32Array) Delete(index MP4ArrayIndex) {
...
func (a *MP4Float32Array) Resize(newSize MP4ArrayIndex) {
	if newSize > a.mMaxNumElements {
		newMElements := make([]float32, newSize)
		copy(newMElements, a.mElements)
		a.mElements = newMElements
	} else {
...
func (a *MP4Float32Array) Get(index MP4ArrayIndex) float32 {
	if a.ValidIndex(index) {
...
func (a *MP4Float32Array) Set(index MP4ArrayIndex, value float32) {
	if a.ValidIndex(index) {

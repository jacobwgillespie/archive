...
// MP4Float64Array needs documentation
type MP4Float64Array struct {
	mElements       []float64
...
func (a *MP4Float64Array) ValidIndex(index MP4ArrayIndex) bool {
	return index < a.mNumElements
}

// Size needs documentation
func (a *MP4Float64Array) Size() MP4ArrayIndex {
	return a.mNumElements
}

// MaxSize needs documentation
func (a *MP4Float64Array) MaxSize() MP4ArrayIndex {
	return a.mMaxNumElements
}

// Add needs documentation
func (a *MP4Float64Array) Add(newElement float64) {
	a.Insert(newElement, a.mNumElements)
}

// Insert needs documentation
func (a *MP4Float64Array) Insert(newElement float64, newIndex MP4ArrayIndex) {
	...
	if a.mNumElements == a.mMaxNumElements {
		...
		newMElements := make([]float64, a.mMaxNumElements)
...
func (a *MP4Float64Array) Delete(index MP4ArrayIndex) {
...
func (a *MP4Float64Array) Resize(newSize MP4ArrayIndex) {
	if newSize > a.mMaxNumElements {
		newMElements := make([]float64, newSize)
		copy(newMElements, a.mElements)
		a.mElements = newMElements
	} else {
...
func (a *MP4Float64Array) Get(index MP4ArrayIndex) float64 {
	if a.ValidIndex(index) {
...
func (a *MP4Float64Array) Set(index MP4ArrayIndex, value float64) {
	if a.ValidIndex(index) {

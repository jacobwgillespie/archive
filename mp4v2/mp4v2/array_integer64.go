...
// MP4Integer64Array needs documentation
type MP4Integer64Array struct {
	mElements       []uint64
...
func (a *MP4Integer64Array) ValidIndex(index MP4ArrayIndex) bool {
	return index < a.mNumElements
}

// Size needs documentation
func (a *MP4Integer64Array) Size() MP4ArrayIndex {
	return a.mNumElements
}

// MaxSize needs documentation
func (a *MP4Integer64Array) MaxSize() MP4ArrayIndex {
	return a.mMaxNumElements
}

// Add needs documentation
func (a *MP4Integer64Array) Add(newElement uint64) {
	a.Insert(newElement, a.mNumElements)
}

// Insert needs documentation
func (a *MP4Integer64Array) Insert(newElement uint64, newIndex MP4ArrayIndex) {
	...
	if a.mNumElements == a.mMaxNumElements {
		...
		newMElements := make([]uint64, a.mMaxNumElements)
...
func (a *MP4Integer64Array) Delete(index MP4ArrayIndex) {
...
func (a *MP4Integer64Array) Resize(newSize MP4ArrayIndex) {
	if newSize > a.mMaxNumElements {
		newMElements := make([]uint64, newSize)
		copy(newMElements, a.mElements)
		a.mElements = newMElements
	} else {
...
func (a *MP4Integer64Array) Get(index MP4ArrayIndex) uint64 {
	if a.ValidIndex(index) {
...
func (a *MP4Integer64Array) Set(index MP4ArrayIndex, value uint64) {
	if a.ValidIndex(index) {

...
func (p *MP4Integer32Property) GetName() string {
	return p.mName
}

// GetType returns the property type
func (p *MP4Integer32Property) GetType() MP4PropertyType {
	return Integer32Property
}

// IsReadOnly returns true if the property is read-only
func (p *MP4Integer32Property) IsReadOnly() bool {
	return p.mReadOnly
}

// SetReadOnly enables setting the property to read-only
func (p *MP4Integer32Property) SetReadOnly(value ...bool) {
	if len(value) == 0 {
		p.mReadOnly = true
	} else {
		p.mReadOnly = value[0]
...
func (p *MP4Integer32Property) IsImplicit() bool {
	return p.mImplicit
}

// SetImplicit sets the property to implicit
func (p *MP4Integer32Property) SetImplicit(value ...bool) {
	if len(value) == 0 {
		p.mImplicit = true
	} else {
		p.mImplicit = value[0]
...
func (p *MP4Integer32Property) GetCount() uint32 {
	return uint32(len(p.mValues))
}

// SetCount needs documentation
func (p *MP4Integer32Property) SetCount(count uint32) {
...
func (p *MP4Integer32Property) FindProperty(name string, ppProperty **MP4Integer32Property, pIndex *uint32) bool {
	if name == "" {
		return false
	}
...
func (p *MP4Integer32Property) GetValue(index uint32) uint32 {
	return p.mValues[index]
}

// SetValue needs documentation
func (p *MP4Integer32Property) SetValue(value uint32, index uint32) {
	if p.mReadOnly {
...
func (p *MP4Integer32Property) AddValue(value uint32) {
	p.mValues = append(p.mValues, value)
}

// InsertValue needs documentation
func (p *MP4Integer32Property) InsertValue(value uint32, index uint32) {
...
func (p *MP4Integer32Property) DeleteValue(index uint32) {
